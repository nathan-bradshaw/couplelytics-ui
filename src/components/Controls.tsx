    ...
    <div className="controls-dark controls">
      ...
      <div className="section">
        ...
        <DualRange
          ...
          onChangeMin={(v) => {
            setAgeMin(v)
            onChange({ ...prefs, ageMin: v, ageMax })
          }}
          onChangeMax={(v) => {
            setAgeMax(v)
            onChange({ ...prefs, ageMin, ageMax: v })
          }}
        />
      ...
      <div className="section">
        ...
        <div className="smart-row">
          ...
          <input
            ...
            onChange={(e) => {
              ...
              if (val != null && val < 50000) setF({ popMin: 50000 })
              else setF({ popMin: val })
            }}
          />
          <input
            className="smart-input"
        ...
        <p className="hint-text hint-tight">Min ≥ 50,000</p>
        ...
        <div className="smart-row smart-row--end">
          <button
            type="button"
            className="reset-btn"
            onClick={() => onFiltersChange({ popMin: 50000 })}
          >
            Reset filters
          </button>
        </div>
